...
def sendToCouchDB(dbName, entry): #couchdb is reachable through masters ip address 
    couch = couchdb.Server("http://vm2:kr@129.114.26.14:30006")#129.114.25.56:5984
...
consumer = KafkaConsumer(bootstrap_servers="129.114.26.14:30001", group_id = "group1") # acquire the consumer
